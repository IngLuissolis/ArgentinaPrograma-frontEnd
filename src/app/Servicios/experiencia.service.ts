...
export class ExperienciaService {
  ...
  registrarExperiencia(experiencia: Experiencia):Observable<Object>{
    let ExperienciaFormData = new FormData();
    ExperienciaFormData = this.cargaFormData(experiencia);

    return this.httpClient.post(`${this.baseUrl}`, ExperienciaFormData); //pasamos experiencia
  }
  ...
  editarExperienciaporId(id: number, experiencia: Experiencia):Observable<Object>{
    ...
    return this.httpClient.put(`${this.baseUrl}/${id}`, ExperienciaFormData);
  }

  cargaFormData(experiencia: Experiencia): FormData {
